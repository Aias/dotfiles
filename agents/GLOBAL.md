...
Writing|skills/write|The sentence is the unit of work. Omit needless words. Clarity over style. Active voice, positive form:L24|No negate-then-reframe, no em dashes, no -ing tails, no dead AI vocabulary, no hedging stacks, no throat-clearing, no sycophancy:L104|PR/commit: problem before solution, present tense, no throat-clearing. Docs: significant everywhere, prefer examples. Rules: maximum density, imperative, no hedging:L142
<!-- END COMPILED -->
