...
Git|skills/git-workflows|Read-only on git status/diff. Explicit permission for commit/push/reset:L21|SSH URLs. Never amend unless explicitly requested; prefer new commits:L25|Single POV as author. No AI attribution or co-authorship:L30
